<?php
    /**
     * Project Name:    Wingman Strux - Typed Graph
    ...
    /**
     * Represents an undirected graph with node value type enforcement.
     *
     ...
     * @extends Graph<V>
     */
    abstract class TypedGraph extends Graph {
        /**
         * Creates a new typed undirected graph.
        ...
        /**
         * Creates a new typed undirected graph pre-loaded with the given nodes and edges.
        ...
        /**
         * Not supported on TypedGraph; the node value type is declared as a class property on the subclass.
